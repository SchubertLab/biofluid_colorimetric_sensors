...
def main():
    ...
    # ROOT_DENBI = '/home/ubuntu/multiarray_color_sensors'
    ...
    # Dataset configs
    N_SYNTHETIC_IMAGES_TRAIN = 24  # 240
    N_SYNTHETIC_IMAGES_VAL = 240  # 240 # 48 # 540
    ...
    SELECTED_MASK = 'temperature'  # 'all_masks' , 'glucose', 'ph', 'temperature' , 'Na' #important
    ...
    # Model configs
    MODEL_PATH = SAVE_PATH + 'unet_mlp_per_var_aug_25/model_unet_mlp_temperature_model_2025_07_21_11_58_29.pt'
    ...
    PROJECT_NAME_WANDB = 'UNET_MLP_2025_07'

    SAVE_EVAL_RESULTS = True

    MODEL_EVAL_RESULTS_PATH = (
            ROOT_PATH +
            'results/unet_mlp_per_var_aug_25/' +
            'model_unet_mlp_model_Na_noise20_2025_07_22.csv'
    )
    ...
    CONFIG = {
        ...
        'model_eval_results_path': MODEL_EVAL_RESULTS_PATH,
    }
    return CONFIG
