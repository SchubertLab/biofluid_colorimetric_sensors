...
def main():
    ...
    N_SYNTHETIC_IMAGES_TRAIN = 128
    N_SYNTHETIC_IMAGES_VAL = 32
    ...
    OPTUNA_METRIC = 'mse'
    OPTUNA_N_TRIALS = 10
    PROJECT_NAME_OPTUNA = 'Sensors_Model_TEMP'
    PROJECT_NAME_WANDB = 'WB_Sensors_Model_TEMP'
    SAVE_PATH_OPTUNA = ROOT_PATH + '/data/optuna_trials/'
    ...
    CONFIG = {
        ...
        'project_name_optuna': PROJECT_NAME_OPTUNA,
        'project_name_wandb': PROJECT_NAME_WANDB,
        'save_path_optuna': SAVE_PATH_OPTUNA,
    }
    return CONFIG
